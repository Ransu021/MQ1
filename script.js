const data = {
  genres: [
    { title: "Action", slug: "action", img: "https://source.unsplash.com/1200x800/?action,film" },
    { title: "Comedy", slug: "comedy", img: "https://source.unsplash.com/1200x800/?comedy,fun" },
    { title: "Drama", slug: "drama", img: "https://source.unsplash.com/1200x800/?drama,story" },
    { title: "Sci-Fi", slug: "scifi", img: "https://source.unsplash.com/1200x800/?sciencefiction,space" },
    { title: "Animation", slug: "animation", img: "https://source.unsplash.com/1200x800/?animation,cartoon" }
  ],
  movies: {
    action: [
      { title: "Edge of Vengeance", img: "https://source.unsplash.com/800x600/?action,explosion", desc: "A rogue ex-agent is forced back into action when a global conspiracy threatens to ignite chaos across continents. Explosions, betrayals, and intense stunts keep the audience on edge. Every scene builds toward an epic face-off that will determine the fate of millions.", platforms: ["Netflix", "HBO Max"] },
    ...
    animation: [
      ...
      { title: "Sky Bound", img: "https://source.unsplash.com/800x600/?sky,clouds,animation", desc: "Two siblings build a flying machine to chase their dreams beyond the clouds. Along the way, they encounter whimsical creatures and breathtaking skies. The story is a celebration of curiosity and courage.", platforms: ["Netflix", "Prime Video"] },
      { title: "Dream Chasers", img: "https://source.unsplash.com/800x600/?dreams,cartoon", desc: "In a city where dreams manifest as living beings, two kids set out to rescue their lost imagination. Filled with humor, adventure, and wonder, the story inspires audiences of all ages. The animation style blends classic and modern techniques beautifully.", platforms: ["HBO Max"] }
    ]
  },
  news: [
    ...
    { title: "Box Office Top 5 This Week", date: "April 2025", img: "https://source.unsplash.com/1200x800/?boxoffice,cinema", excerpt: "Audiences are flocking back to theaters with an exciting mix of blockbusters. From sci-fi spectacles to heartfelt dramas, the box office is buzzing again. This week proves that movie magic is alive and thriving." }
  ],
  cinemas: [
    { name: "TCL Chinese Theatre", location: "Hollywood, USA", img: "https://source.unsplash.com/1200x800/?hollywood,theater", fact: "This iconic cinema has hosted countless Hollywood premieres. Its grand architecture and historic legacy make it a landmark destination." },
    ...
    { name: "Pathé Tuschinski", location: "Amsterdam, Netherlands", img: "https://source.unsplash.com/1200x800/?amsterdam,cinema", fact: "Known for its art deco design, this cinema is considered one of the most beautiful theaters in the world. It blends history with a magical moviegoing experience." }
  ]
};
