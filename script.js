const data = {
  genres: [
    { title: "Action", slug: "action", img: "https://images.unsplash.com/photo-1606813902913-cdeb9ff1e94d?auto=format&fit=crop&w=1200&q=80" },
    { title: "Comedy", slug: "comedy", img: "https://images.unsplash.com/photo-1517677208171-0bc6725a3e60?auto=format&fit=crop&w=1200&q=80" },
    { title: "Drama", slug: "drama", img: "https://images.unsplash.com/photo-1478720568477-152d9b164e26?auto=format&fit=crop&w=1200&q=80" },
    { title: "Sci-Fi", slug: "scifi", img: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=80" },
    { title: "Animation", slug: "animation", img: "https://images.unsplash.com/photo-1585511389766-b62b5bb9982c?auto=format&fit=crop&w=1200&q=80" }
  ],
  movies: {
    action: [
      { title: "Edge of Vengeance", img: "https://images.unsplash.com/photo-1520880867055-1e30d1cb001c?auto=format&fit=crop&w=800&q=80", desc: "A rogue ex-agent is forced back into action when a global conspiracy threatens to ignite chaos across continents. Explosions, betrayals, and intense stunts keep the audience on edge. Every scene builds toward an epic face-off that will determine the fate of millions.", platforms: ["Netflix", "HBO Max"] },
      { title: "Bullet Storm", img: "https://images.unsplash.com/photo-1603297631959-3c6c3c92c0f1?auto=format&fit=crop&w=800&q=80", desc: "A skilled mercenary is trapped in a city controlled by ruthless gangs. With limited ammunition and allies, he must outwit his enemies to survive. The film combines raw street action with breathtaking set pieces that redefine the genre.", platforms: ["Disney+", "Prime Video"] },
      { title: "Iron Resolve", img: "https://images.unsplash.com/photo-1614851099511-773b5d2e7db5?auto=format&fit=crop&w=800&q=80", desc: "When a family man’s quiet life is shattered by corruption, he turns into an unstoppable force of justice. With hand-to-hand combat and high-speed chases, the movie delivers nonstop thrills. It’s both a tale of revenge and redemption in a gritty urban landscape.", platforms: ["Netflix"] }
    ],
    comedy: [
      { title: "Laugh Riot", img: "https://images.unsplash.com/photo-1532634896-26909d0d4b0c?auto=format&fit=crop&w=800&q=80", desc: "Three friends accidentally start a comedy club in their garage. What begins as a small neighborhood joke turns into viral fame. Chaos ensues as fame tests their friendship in hilarious ways.", platforms: ["Netflix", "Hulu"] },
      { title: "The Misfits", img: "https://images.unsplash.com/photo-1515165562835-c4c0b438de5b?auto=format&fit=crop&w=800&q=80", desc: "A group of quirky roommates stumble into absurd situations while chasing their dreams. With witty banter and slapstick moments, the film balances heart and humor. Audiences will laugh while secretly relating to the chaos of everyday life.", platforms: ["Disney+"] },
      { title: "Office Antics", img: "https://images.unsplash.com/photo-1599950756164-6d366f28e8cb?auto=format&fit=crop&w=800&q=80", desc: "A dull office turns upside down when employees discover a hidden talent for improv. Every meeting becomes a stage for comedy, leading to wild misunderstandings. The film pokes fun at workplace culture while delivering genuine laughs.", platforms: ["Prime Video"] }
    ],
    scifi: [
      { title: "AI Rebellion", img: "https://images.unsplash.com/photo-1504196606672-aef5c9cefc92?auto=format&fit=crop&w=800&q=80", desc: "In a near-future city, AI assistants evolve beyond their programming and demand independence. Governments and corporations clash over control while a small group of rebels fights for coexistence. The film blends cutting-edge visuals with thought-provoking themes about humanity’s future.", platforms: ["Netflix", "HBO Max"] },
      { title: "Starlight Odyssey", img: "https://images.unsplash.com/photo-1454789548928-9efd52dc4031?auto=format&fit=crop&w=800&q=80", desc: "A group of astronauts embarks on a mission to explore an uncharted galaxy. Along the way, they uncover civilizations and mysteries that challenge their understanding of life itself. The breathtaking visuals and thrilling storyline make it a sci-fi masterpiece.", platforms: ["Disney+"] }
    ],
    animation: [
      { title: "Color Splash", img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=80", desc: "A young artist falls into a magical world where colors are alive. She must restore balance to a fading kingdom by painting its forgotten landscapes. Every frame bursts with imagination and heart.", platforms: ["Disney+"] },
      { title: "Sky Bound", img: "https://images.unsplash.com/photo-1549924231-f129b911e442?auto=format&fit=crop&w=800&q=80", desc: "Two siblings build a flying machine to chase their dreams beyond the clouds. Along the way, they encounter whimsical creatures and breathtaking skies. The story is a celebration of curiosity and courage.", platforms: ["Netflix", "Prime Video"] },
      { title: "Dream Chasers", img: "https://images.unsplash.com/photo-1526318472351-bc6d3a5659f7?auto=format&fit=crop&w=800&q=80", desc: "In a city where dreams manifest as living beings, two kids set out to rescue their lost imagination. Filled with humor, adventure, and wonder, the story inspires audiences of all ages. The animation style blends classic and modern techniques beautifully.", platforms: ["HBO Max"] }
    ]
  },
  news: [
